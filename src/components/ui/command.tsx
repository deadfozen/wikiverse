...
function CommandDialog({title="Command Palette", description="Поиск команды для выполнения...", children, className, showCloseButton=true, ...props}: React.ComponentProps<typeof Dialog> & {
    title?: string
    description?: string
    className?: string
